...
namespace PrettyXmlInLog
{
    ...
    {
        #region " Fields "
        internal const string PluginName = "PrettyXmlInLog";
        ...
        internal static void CommandMenuInit()
        {
			...
			PluginBase.SetCommand(0, "MyMenuCommand", myMenuFunction, new ShortcutKey(true, true, true, Keys.L));
        ...
        internal static void myMenuFunction()
        {
	        ...
	        var length = (int)Win32.SendMessage(hCurrentEditView, SciMsg.SCI_GETCURLINE, 0, 0);
	        
			var lineStringBuilder = new StringBuilder(length);
			Win32.SendMessage(hCurrentEditView, SciMsg.SCI_GETCURLINE, length, lineStringBuilder);
	        MessageBox.Show(lineStringBuilder.ToString());
